                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm">
                                <div class="form-group">
                                    <label for="editName">Lecturer Id</label>
                                    <input type="text" class="form-control" id="editName">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="editOffice">Gender</label>
                                    <input type="text" class="form-control" id="editOffice">
                                </div>
                                <div class="form-group">
                                    <label for="editAge">Email</label>
                                    <input type="email" class="form-control" id="editAge">
                                </div>
                                <div class="form-group">
                                    <label for="editStart">Tel</label>
                                    <input type="number" class="form-control" id="editStart">
                                </div>
                                <div class="form-group">
                                    <label for="editSalary">Course</label>
                                    <input type="text" class="form-control" id="editSalary">
                                </div>
